---
title: "Case clinic 1: the library sub-basement stacks"
description:
  The first supervised on-campus observation — a sub-basement stack range in
  the university library that is reliably a different shape at closing than
  it was at opening.
week: 5
date: 2027-03-22
teachers:
...
template and a torch — the sub-basement's lighting is original to the
building.

## In the session

The case: the library's sub-basement stack range (Levels −1 and −2,
humanities periodicals) does not consistently return the same floor plan
between opening and closing. Aisle counts, dead ends, and the location of the
fire door to the stairwell have all been logged differently by different
