...
## Status: content redesign complete (12/12 weeks); shipped and live at https://comp4020-agentic-coding-studio.github.io/comp4020-ass2-YueheSun/ (Assignment 2, due 2026-09-21T12:00). Post-ship polish audit is now **closed** — see "Full-site audit" below; 22 of 23 items done (1 partially — #22, a deliberately non-exhaustive pass, see that row), 1 formally deferred (#23 — decided against attempting, see that row for reasoning). **Next step for a cold reader: there isn't one from this audit — it's fully worked through. Any further changes need a new reason to reopen it, not a continuation of this checklist.**
...
| 23 | No dark/"redacted-document" surface treatment anywhere outside the decks | Atmosphere | Low | Large | **Deferred, decided against attempting** — weighed against the site's current state: already shipped, live, and independently verified before the 2026-09-21T12:00 deadline, which has now passed. A sitewide surface-color CSS change carries real contrast risk (item #6 already found a real WCAG failure from a much narrower, single-value color override on the deck theme; a sitewide light/dark surface swap touching every page template is a substantially larger version of that same risk) for a Low-priority, Atmosphere-only payoff, with no remaining checkable milestone before assessment. Not worth the risk/effort trade at this stage — closing rather than leaving open indefinitely. Audit is now fully worked: 22/23 done (1 of those, #22, partially per its own explicit scope), 1 formally deferred |
