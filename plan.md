...
## Status: content redesign complete (12/12 weeks); shipped and live at https://comp4020-agentic-coding-studio.github.io/comp4020-ass2-YueheSun/ (Assignment 2, due 2026-09-21T12:00). Post-ship polish audit in progress — see "Full-site audit" below; 22 of 23 items done (1 partially — #22, a deliberately non-exhaustive pass, see that row), 1 left for a human call (#23 — large-effort dark/"redacted-document" CSS treatment, real visual/contrast risk). **Next step for a cold reader: decide whether #23 is worth attempting (see that row), otherwise the audit is closed out — update this line if #23 is picked up or formally deferred.**
