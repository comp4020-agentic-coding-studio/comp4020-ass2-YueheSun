...
## Status: content redesign complete (12/12 weeks); shipped and live at https://comp4020-agentic-coding-studio.github.io/comp4020-ass2-YueheSun/ (Assignment 2, due 2026-09-21T12:00). Post-ship polish audit in progress — see "Full-site audit" below; 21 of 23 items done, 1 explicitly skipped (#22, per the audit's own recommendation), 1 left for a human call (#23 — large-effort dark/"redacted-document" CSS treatment, real visual/contrast risk). User stepped away and asked the agent to work through the remaining checklist unattended; that list is now fully worked through. **Next step for a cold reader: decide whether #23 is worth attempting (see that row), otherwise the audit is closed out — update this line if #23 is picked up or formally deferred.**
...
| 22 | Site-wide em-dash density (deliberate voice choice; only worth a pass if a full copy-edit happens anyway) | Readability | Low | Large | Skipped — audit's own recommendation is this is only worth doing as part of a full copy-edit pass, not standalone; no such pass is in progress |
| 23 | No dark/"redacted-document" surface treatment anywhere outside the decks | Atmosphere | Low | Large | Not attempted — large sitewide CSS change with real visual/contrast risk. Audit checklist is now otherwise fully worked (21 done, 1 explicitly skipped per its own recommendation); this is the one item left for a human call on whether it's worth the effort at this stage |
